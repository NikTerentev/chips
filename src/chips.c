                        ...
                        AppState *appstate)
{
  ...
  case 0x4:
    ...
    snprintf(*message, 256, "Skip next instruction if V%x is not equal to %x",
             second_nibble, third_and_fourth_nibbles);
    break;
  case 0x5:
  ...
  case 0x9:
    ...
    snprintf(*message, 256, "Skip next instruction if V%x is not equal to V%x",
             second_nibble, third_nibble);
    break;
  case 0xA:
  ...
  case 0xE:
    ...
    case 0x9E:
      ...
      if (appstate->keyboard_state[key_scancode]) {
        ...
        snprintf(*message, 256, "Key %zx is pressed, next instruction skipped.",
                 key_scancode);
        break;
      }
      break;
